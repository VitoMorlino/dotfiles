...
wezterm.on("fzf-dir", function(window, pane)
	-- call an alias set in $HOME/.bash_profile that should cd into a fuzzily-found directory
	pane:send_text("fzf-dir\n")
...
config.keys = {
	{
		mods = "CTRL",
		key = "f",
		action = wezterm.action.EmitEvent("fzf-dir"),
	},
	{
		key = "E",
		mods = "CTRL|SHIFT|ALT",
