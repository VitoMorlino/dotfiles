...
* Configure =org-mode=
TODO: look into how to automatically indent the contents of bullets below the
top level - like they currently do when demoting to a lower level
Note: This functionality might already be included with =org-bullets=
